...
Remember, you may use the descriptive statistics tools from [notebook 26](https://straightdraw.github.io/stats/tests/6.html).
...
Remember, you may use the A/B testing tools from [notebook 20](https://straightdraw.github.io/stats/tests/0.html) and [notebook 21](https://straightdraw.github.io/stats/tests/1.html).
...
Discuss your findings. Remember, you may use the bootstrapping tools from [notebook 24](https://straightdraw.github.io/stats/tests/4.html) and [notebook 25](https://straightdraw.github.io/stats/tests/5.html) along with the descriptive statistics tools in [notebook 26](https://straightdraw.github.io/stats/tests/6.html)
...
Remember, you may use the tools from [notebook 24](https://straightdraw.github.io/stats/tests/4.html) and [notebook 25](https://straightdraw.github.io/stats/tests/5.html).
...
Remember, you may use the correlation and regression tools from [notebook 26](https://straightdraw.github.io/stats/tests/6.html) and [notebook 27](https://straightdraw.github.io/stats/tests/7.html)
